...
namespace Coding4Fun.CurrencyExchange
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private void SwapCurrenciesIconButton_Click(object sender, EventArgs e)
        {
            var viewModel = DataContext as MainViewModel;
        ...
        {
            MessageBox.Show("thinkIT Limited \n Currency Converter");
            var about = new Coding4FunAboutPrompt();
            

            about.Show("thinkIT", "Currency conveter", "gittabrian@gmail.com", "http://matibabu.blog.com");
        }
    }
}