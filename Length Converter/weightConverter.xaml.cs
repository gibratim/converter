...
{
    public partial class weightConverter : PhoneApplicationPage
    {
        ...
        {
            lstFrom.ItemsSource = new WeightList();
            lstTo.ItemsSource = new WeightList();
        }
        private void lFrom_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    btnLstFrom.Content = "ounce";
                }
                if (lstFrom.SelectedIndex.Equals(3))
                {
                    btnLstFrom.Content = "pound";
                }
                if (lstFrom.SelectedIndex.Equals(4))
                {
                    btnLstFrom.Content = "tonnes";
                }
                if (lstFrom.SelectedIndex.Equals(5))
                {
                    btnLstFrom.Content = "milligrams";
                }
                ...
                if ((btnLstFrom.Content.Equals("Kgs") && (btnLstTo.Content.Equals("Kgs"))))
                {
                ...
                if ((btnLstFrom.Content.Equals("Kgs") && (btnLstTo.Content.Equals("grams"))))
                {
        ...
        {
            NavigationService.Navigate(new Uri(string.Format("/weightConverter.xaml?Refresh=true&random={0}", Guid.NewGuid()), UriKind.Relative));
        }
    }
}