...
// 
namespace Length_Converter.ConverterService {
    ...
    public interface CurrencyConvertorSoap {
        ...
        System.IAsyncResult BeginConversionRate(Length_Converter.ConverterService.Currency FromCurrency, Length_Converter.ConverterService.Currency ToCurrency, System.AsyncCallback callback, object asyncState);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface CurrencyConvertorSoapChannel : Length_Converter.ConverterService.CurrencyConvertorSoap, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CurrencyConvertorSoapClient : System.ServiceModel.ClientBase<Length_Converter.ConverterService.CurrencyConvertorSoap>, Length_Converter.ConverterService.CurrencyConvertorSoap {
        ...
        System.IAsyncResult Length_Converter.ConverterService.CurrencyConvertorSoap.BeginConversionRate(Length_Converter.ConverterService.Currency FromCurrency, Length_Converter.ConverterService.Currency ToCurrency, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginConversionRate(FromCurrency, ToCurrency, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        double Length_Converter.ConverterService.CurrencyConvertorSoap.EndConversionRate(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginConversionRate(object[] inValues, System.AsyncCallback callback, object asyncState) {
            Length_Converter.ConverterService.Currency FromCurrency = ((Length_Converter.ConverterService.Currency)(inValues[0]));
            Length_Converter.ConverterService.Currency ToCurrency = ((Length_Converter.ConverterService.Currency)(inValues[1]));
            return ((Length_Converter.ConverterService.CurrencyConvertorSoap)(this)).BeginConversionRate(FromCurrency, ToCurrency, callback, asyncState);
        }
        
        private object[] OnEndConversionRate(System.IAsyncResult result) {
            double retVal = ((Length_Converter.ConverterService.CurrencyConvertorSoap)(this)).EndConversionRate(result);
            return new object[] {
                    retVal};
        }
        ...
        public void ConversionRateAsync(Length_Converter.ConverterService.Currency FromCurrency, Length_Converter.ConverterService.Currency ToCurrency) {
            this.ConversionRateAsync(FromCurrency, ToCurrency, null);
        }
        
        public void ConversionRateAsync(Length_Converter.ConverterService.Currency FromCurrency, Length_Converter.ConverterService.Currency ToCurrency, object userState) {
        ...
        protected override Length_Converter.ConverterService.CurrencyConvertorSoap CreateChannel() {
            return new CurrencyConvertorSoapClientChannel(this);
        }
        
        private class CurrencyConvertorSoapClientChannel : ChannelBase<Length_Converter.ConverterService.CurrencyConvertorSoap>, Length_Converter.ConverterService.CurrencyConvertorSoap {
            
            public CurrencyConvertorSoapClientChannel(System.ServiceModel.ClientBase<Length_Converter.ConverterService.CurrencyConvertorSoap> client) : 
                    base(client) {
            }
            
            public System.IAsyncResult BeginConversionRate(Length_Converter.ConverterService.Currency FromCurrency, Length_Converter.ConverterService.Currency ToCurrency, System.AsyncCallback callback, object asyncState) {
